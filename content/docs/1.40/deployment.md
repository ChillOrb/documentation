...
* [PostgreSQL with Promscale]() - Jaeger and Prometheus storage backend built on PostgreSQL. For more information, see [sending data using the Jaeger Collector](https://docs.timescale.com/promscale/latest/send-data/jaeger/).
